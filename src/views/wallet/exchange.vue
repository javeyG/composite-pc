      ...
      <div class="content css-81xrsn">
        ...
        <div class="title-box-view">
          <div class="css-11y6cix">
            <el-icon><ArrowLeftBold @click="OnClickPre" /></el-icon>
  ...
  methods: {
    ...
    getTrans() {
      ...
      Axios2.getTrans(params).then((res) => {
        var jsonArray = res;
        if (jsonArray.code == 0) {
          this.$message.success(this.$t("message.user.duihuanchenggong"));
        } else if (jsonArray.code == 1) {
        }
        this.getExchangeapplyorderView();
      });
    },
...
@import url("@/assets/wallet/recharge.css");
@import url("@/assets/wallet/exchange.css");
...
@import '../../assets/wallet/exchange.css'; */
</style>

    ...
    <div class="miner-background">
      <div style="width: 1200px; margin: 0 auto">
        ...
        <div style="width: 1200px; height: 160px; position: relative">
          ...
          >
          <a
            class="theme-color wealth-btn-kuangchi"
            @click="
              {
              }
            "
        ...
        >
          <template #default="scope">
            <div class="flex-row-center">
              ...
              <img
                src="../../assets/myImages/icon/money1.png"
                alt="picture"
                width="58px"
                height="40px"
              />
...
export default {
  ...
  methods: {
    ...
    getlist() {
      Axios.fetch("api/miner!list.action").then((res) => {
    ...
    //理财收益统计
    getIncome() {
      Axios.fetch("api/minerOrder!listSum.action").then((res) => {

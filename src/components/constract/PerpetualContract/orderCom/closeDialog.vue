<template>
  ...
  >
    <div class="body-wrapper">
      ...
      <div class="coin-info">
        <span class="name">
          {{ info?.symbol?.toUpperCase() }}USD {{ $t("message.home.yongxu") }}
        </span>
      ...
      <div v-if="type === 'limit'">
        ...
        <div class="btns">
          ...
          <el-button @click="handleSubmit" class="btn-limit-submit">{{
    ...
    showLimitInfoData: function () {
      return [
        ...
        },
        {
          ...
          value: `${this.newPrice} USD`,
        },
        {
          label: this.$t("message.home.yujiyingkui"),
          value: `${bigDecimal.round(this.newPrice * this.info.amount, 4)} USD`,
          class: this.sellOrBuy === "buy" ? "buy-color" : "sell-color",
        },
      ];
    },

  ...
  <section class="header-index">
    <div class="header-index-w">
      ...
      <div class="flex justify-between text-sm">
        ...
        <div class="flex">
          <p class="menu" @click="gotoPage('/support')">
            {{ t("header-s1-4") }}
          </p>
          <p class="menu" @click="gotoPage('/refer-friend')">
            {{ t("header-s1-5") }}
          </p>
          <!-- 多语言 -->
          <el-select
      ...
      <div class="flex items-center mt-4">
        ...
        >
          <img
            class="mr-4"
            src="@/assets/forexImages/logo.png"
            width="46"
            height="25"
          />
        ...
        <div class="flex flex-2">
          ...
          >
            <div
              class="text-base mr-8 text-white"
              @click="gotoPage(_item.path)"
            >
              {{ t(_item.label) }}
            </div>
            <template #dropdown>
        ...
        <div class="flex flex-1 justify-end items-center">
          <el-button
            ...
            @click="gotoPage('/etf/spot/GlobalETF500')"
          >
            {{ t("trade-center") }}
          </el-button>
          <h6
          ...
          <el-button v-else class="blue-small-btn" @click="gotoPage('/login')">
            {{ t("ready-b1") }}
          </el-button>
        </div>
      </div>
